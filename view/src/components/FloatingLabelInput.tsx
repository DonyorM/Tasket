...
export default function FloatingLabelInput({ type, name, children, className, value, onChange, onValueChange, onEnterPress, inputRef, ...props } : InputProps) {
    ...
    return (
      <div className={`relative border rounded bg-gray-600 text-white border-white border-opacity-25 ${className}`}>
        <input
          className={[
